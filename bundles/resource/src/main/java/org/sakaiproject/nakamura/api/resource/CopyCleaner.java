 ...
 * </p>
 * <p>
 * A copy cleaner responds to the copying of content. Copy cleaners are intended to
 * respond to content with a specific resource type. The resource type is defined by setting the
 * component configuration property of:
 * </p>
 * 
 * <pre>
 * sakai.copycleaner.resourcetype
 * </pre>
 * 
 * {@link CopyCleaner#RESOURCE_TYPE}
 * <p>
...
public interface CopyCleaner {
  ...
  /**
   * Clean some content after it has been copied. This method is guaranteed to receive a
