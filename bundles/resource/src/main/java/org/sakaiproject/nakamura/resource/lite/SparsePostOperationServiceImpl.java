...
public class SparsePostOperationServiceImpl implements SparsePostOperationService {
  ...
  /**
   * {@inheritDoc}
   * @see org.sakaiproject.nakamura.api.resource.lite.SparsePostOperationService#move(org.sakaiproject.nakamura.api.lite.content.ContentManager, java.lang.String, java.lang.String)
   */
  @Override
