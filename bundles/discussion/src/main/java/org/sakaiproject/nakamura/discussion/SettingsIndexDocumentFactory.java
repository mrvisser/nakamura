...
@Service
public class SettingsIndexDocumentFactory implements IndexDocumentFactory {
  ...
  public IndexDocument createIndexDocument(String path, Map<String, Object> properties) {
    ...
    if (!"sakai/settings".equals(resourceType))
      return null;
    
    SettingsIndexDocument doc = new SettingsIndexDocument();
    doc.id = path;
